...
const renderRow = (item: Student) => (
    <tr
    className='border-b border-gray-200 even:bg-slate-50 text-sm hover:bg-secondaryLight' 
    key={item.id}
    >
        ...
        <td>
            <div className='flex items-center gap-2'>
                <Link href={`/list/teachers/${item.id}`}>
                    <button className='w-7 h-7 flex items-center justify-center rounded-full bg-permanent'>
